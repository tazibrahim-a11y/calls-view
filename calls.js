...
const DEMO=[
  ...
  {title:"Sismatec Demo",rep:"Niels",date:"2026-06-19",dur:"33m",UC:4,VA:3,WF:4,CO:3,NS:4,PC:3,score:3.2,outcome:"follow_up_call_booked",well:"Strong demo tailored to context. AFAS integration, virtual cards, approval workflows all covered. Follow-up Jul 2 14:00.",wrong:"DM (Wim) mostly silent. No ROI quantified. Pricing deferred 2+ weeks. B2B booking objection unresolved."},
...
const UPCOMING={
  sourcing:[
    {rep:"Aurel",call:"Ruben Faust",date:"Tue Jun 23, 2pm",type:"prospect",prepFlag:"warn",prepNote:"Booked from today's call (4.0). Interim CFO. Before joining: qualify client base size, which clients use expense management, decision authority."},
    {rep:"Aurel",call:"Torsten Mayer",date:"Mon Jun 23, 4pm",type:"prospect",prepFlag:"warn",prepNote:"Booked from today's call (3.0). Interim Manager. Define pre-call objective and discovery questions before joining."},
  ],
  discovery:[
    {rep:"Aurel",call:"Benjamin Pasqualino Demo",date:"Mon Jun 23, 2pm",type:"prospect",prepFlag:"warn",prepNote:"Booked from today's call. DATEV integration need. Confirm pain points and bring Solution Consultant for technical questions."},
    {rep:"Aurel",call:"IG Immobilien Demo",date:"Tue Jun 23, 11am",type:"prospect",prepFlag:"ok",prepNote:"Booked from Jun 16 discovery (4.7/5). 25+ stakeholders + EY AT. Prep Eingangsrechnungsmanagement and workflow demo."},
  ],
  demo:[
    {rep:"Jara",call:"score business x Moss",date:"Mon Jun 22, 2pm",type:"partner",prepFlag:"ok",prepNote:"Agenda set: Chaka2, Pankl update, Moss Open API, email campaign. ✅ Best prepped call this week."},
    {rep:"Jara",call:"Moss x Integral",date:"Mon Jun 22, 3pm",type:"prospect",prepFlag:"warn",prepNote:"lukas.zoerner@integral.de + moritz.kobler@integral.de. New prospect — define use case and qualification objective before joining."},
    {rep:"Niels",call:"Sismatec follow-up",date:"Thu Jul 2, 2pm",type:"prospect",prepFlag:"warn",prepNote:"Send written answers to open questions (AFAS export timing, lease facturen, procuratieschema) before this call. Committed on the call."},
    {rep:"Niels",call:"Modjo / Mark Zandbergen",date:"Thu Jul 3, 10am",type:"prospect",prepFlag:"warn",prepNote:"15-min check-in. Set specific deliverable: All2MD diagnostic complete OR new client intro confirmed. Don't let it be a vague status call."},
    {rep:"Alex",call:"Iscoseles Finance demo",date:"Mon Jun 22 (TBC)",type:"prospect",prepFlag:"missing",prepNote:"Demo booked from Fri discovery (4.7/5) but no firm time set. Lock date today — send agreement and confirm time."},
  ],
  management:[
    {rep:"Jara",call:"Weekly Partnerships Kickoff",date:"Mon Jun 22, 10am",type:"internal",prepFlag:"ok",prepNote:"Full team. EOQ Sprint week. Jara: bring UK pipeline update — APA result (sponsorship model, not referral), RSM next steps, Xeinadin Russell status."},
    {rep:"Jara",call:"UK Kickoff & Pipeline Sync",date:"Mon Jun 22, 11am",type:"internal",prepFlag:"ok",prepNote:"UK team only (Jara, Ezer, Alex). Pipeline sync before EOQ Sprint."},
    {rep:"Jara",call:"Poool GTM",date:"Mon Jun 22, 6:30pm",type:"partner",prepFlag:"missing",prepNote:"Scored 3.2 last time. No objective set. What is the referral commitment? Has Natalie actioned anything since last call?"},
    {rep:"Jara",call:"Poool exit plan",date:"Tue Jun 23, 1pm",type:"partner",prepFlag:"warn",prepNote:"⚠️ This is an exit plan meeting with Kirill (CSM). Signals Poool may be churning. Bring context on partnership status and any open commitments."},
    {rep:"Nicola",call:"AMICON DATEV 2-Way",date:"Mon Jun 22, 11am",type:"prospect",prepFlag:"ok",prepNote:"fabian.greykowski@amicon-partners.de confirmed. DATEV 2-way integration session. Prep qualifying questions: client base, ICP, referral model."},
    {rep:"Nicola",call:"Knappworst / Moss",date:"Mon Jun 22, 3:30pm",type:"prospect",prepFlag:"warn",prepNote:"s.kell@knappworst.de. Set qualification objective before joining."},
...
function renderPipeline(){
  ...
  mkChart('p-sql','bar',{
    ...
    datasets:[
      ...
      {label:'NL',data:[9,9,15,9,9,8],backgroundColor:'#4a8ec2',borderWidth:0,borderRadius:3}
    ]
